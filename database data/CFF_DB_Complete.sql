...
ALTER TABLE `student` ADD COLUMN `lastMoodleEngagement`date DEFAULT NULL AFTER `emailAddress`;
...
ADD COLUMN `isActive` TINYINT DEFAULT NULL AFTER `SessionDay`;
...
ALTER TABLE `attenbooking` DROP `lastEngagement`;